...
export default class GLTFMaterialParser {
  constructor(gl, {attributes, material, pbrDebug, imageBasedLighting, lights}) {
    this.gl = gl;
    ...
    if (imageBasedLighting) {
      this.uniforms.u_DiffuseEnvSampler = imageBasedLighting.getDiffuseEnvSampler();
      this.uniforms.u_SpecularEnvSampler = imageBasedLighting.getSpecularEnvSampler();
      this.uniforms.u_brdfLUT = imageBasedLighting.getBrdfTex();
    ...
    this.defineIfPresent(imageBasedLighting, 'USE_IBL');
